"""
Django settings for templatization project.
...
SECRET_KEY = '^u^%d^ttpu@uvq_f-&k0o5^zyj%v6%b4($-gx*vmz(2*8vrp-4'
...
ROOT_URLCONF = 'templatization.urls'
...
WSGI_APPLICATION = 'templatization.wsgi.application'
